...
args$outfile <- paste0(io$basedir,"/processed/rna_soupX/SingleCellExperiment.rds")
args$samples <- opts$samples
args$metadata <- paste0(io$basedir,"/results/rna_soupX/qc/sample_metadata_after_qc.txt.gz")
args$seurat <- paste0(io$basedir,"/processed/rna_soupX/seurat.rds")
args$test <- FALSE
